...
<h2><?php  echo __('Courses User'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo $this->Html->link($coursesUser['Course']['title'], array('controller' => 'courses', 'action' => 'view', $coursesUser['Course']['id'])); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo $this->Html->link($coursesUser['Status']['name'], array('controller' => 'statuses', 'action' => 'view', $coursesUser['Status']['id'])); ?>
			&nbsp;
		</dd>
	</dl>
</div>
